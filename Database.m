...
%   Output: An n x 2 cell (like a dictionary, use help cell to learn more)
%   where n is the number of images in total. For the i th image,
%   database(i,1) is the rotation matrix R of the i th camera and
%   database(i,2) is the translation matrix T of the i th camera. Please
